...
export class AboutUs extends Component {
  ...
  render() {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r dark:bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r">
        <div className="text-white text-center px-8 py-12">
          ...
          <div className="mb-6">
            ...
            <p className="text-lg mb-4">
              Idea: Combination of 2D -> 3D floor plan conversion + Indoor
              Mapping & Navigation.
            </p>
          </div>

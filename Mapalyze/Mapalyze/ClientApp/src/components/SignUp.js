      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-lg">
        ...
        <form className="mt-8 space-y-6">
          ...
          <div className="flex items-center justify-center">
            <button type="button" onClick={handleSignup} className="w-full px-4 py-2 text-lg font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
              Sign Up
            </button>
          </div>
        </form>
